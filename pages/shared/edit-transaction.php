        ...
        <div id="main-content" style="margin-bottom: 100px;">
            <div class="container py-4 py-xl-5" style="padding-bottom: 48px;height: 160px;">
                <div class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex d-xxl-flex justify-content-end justify-content-sm-end justify-content-md-end justify-content-lg-end justify-content-xl-end justify-content-xxl-end" style="display: inline-flex;margin-bottom: 10px;">
                    <div class="d-xxl-flex me-auto justify-content-xxl-start"><a href="my-credits.html" style="text-decoration:none;">
                ...
                <div class="row mb-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        <h2 style="display: inline-flex;">Редактиране на транзакция</h2>
                    </div>
                </div>
            </div>
            <div>
                                            ...
                                            <div class="card mb-5">
                                                <div class="card-body d-flex flex-column align-items-center">
                                                    <form class="text-center" method="post">
                                                        ...
                                                        <div class="mb-3"><label class="form-label d-xxl-flex" style="width: 207px;margin-bottom: 1px;font-size: 14px;text-align: left;">Дата</label><input class="form-control" type="date" style="border-color: rgb(222,226,230);color: var(--bs-secondary);"></div>
                                                        <div style="margin-bottom: 16px;"><label class="form-label d-xxl-flex" style="width: 207px;margin-bottom: 1px;font-size: 14px;text-align: left;">Сума</label><input class="form-control" type="text" style="text-align: left;"></div>
                                                        <div style="margin-bottom: 16px;"><label class="form-label d-xxl-flex" style="width: 207px;margin-bottom: 1px;font-size: 14px;text-align: left;">Причина</label><input class="form-control" type="text"></div>
                                                        <div class="mb-3"><button class="btn btn-warning d-block w-100" type="submit">Редактиране</button>
                                                            <div>
                                                                <p style="font-style: italic;color: rgb(255,15,0);margin-top: 10px;">Изтриване на транзакция</p>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
