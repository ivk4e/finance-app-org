            ...
            <div class="container py-4 py-xl-5" style="padding-bottom: 48px;height: 160px;">
                ...
                <div class="row mb-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        <h2 style="display: inline-flex;">Редактиране на финансово задължение</h2>
                    </div>
                </div>
            </div>
            <div>
                                            ...
                                            <div class="card mb-5">
                                                <div class="card-body d-flex flex-column align-items-center">
                                                    <form class="text-center" method="post">
                                                        ...
                                                        <div style="margin-bottom: 16px;"><label class="form-label d-xxl-flex" style="width: 207px;margin-bottom: 1px;font-size: 14px;text-align: left;">Платена сума</label><input class="form-control" type="text"></div>
                                                        ...
                                                        <div class="mb-3"><button class="btn btn-warning d-block w-100" type="submit">Запазване</button>
                                                            <div>
                                                                <p style="font-style: italic;color: rgb(255,15,0);margin-top: 10px;">Изтриване на задължение</p>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
